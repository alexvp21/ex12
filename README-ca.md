...
La fluidez en la línea de comando es una habilidad que a menudo se descuida o se considera arcana, pero mejora su flexibilidad y productividad como ingeniero tanto de manera obvia como sutil. Esta es una selección de notas y consejos sobre el uso de la línea de comandos que hemos encontrado útiles al trabajar en Linux. Algunos consejos son elementales y otros son bastante específicos, sofisticados u oscuros. Esta página no es larga, pero si puede usar y recuperar todos los elementos aquí, sabe mucho.
